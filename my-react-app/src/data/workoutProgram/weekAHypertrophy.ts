import { WeekAHypertrophyWorkout } from '../../schemas'

export const weekAHypertrophy: WeekAHypertrophyWorkout = {
  week: 'A',
  style: 'hypertrophy',
  workouts: [
    {
    ...
    },
    {
      ...
      description: 'High-intensity full body with volume emphasis',
      week: 'A',
      day: 'Friday',
      style: 'hypertrophy',
      focus: ['fullBody', 'core'],
