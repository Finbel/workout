import { WeekBStrengthWorkout } from '../../schemas'

export const weekBStrength: WeekBStrengthWorkout = {
  week: 'B',
  style: 'strength',
  workouts: [
    {
      id: 'week-b-monday-strength',
      name: 'Push Day - Strength',
      description: 'Heavy weight incline focus (6-8 reps)',
      week: 'B',
      day: 'Monday',
      style: 'strength',
    ...
    {
      id: 'week-b-tuesday-strength',
      name: 'Pull Day - Strength',
      description: 'Heavy weight back focus with isometrics (6-8 reps)',
      week: 'B',
      day: 'Tuesday',
      style: 'strength',
    ...
    {
      id: 'week-b-wednesday-strength',
      name: 'Legs Day - Strength',
      description: 'Heavy weight front squat focus (6-8 reps)',
      week: 'B',
      day: 'Wednesday',
      style: 'strength',
    ...
    {
      id: 'week-b-thursday-strength',
      name: 'Arms Day - Strength',
      description: 'Heavy weight arms with drop sets (6-8 reps primary sets)',
      week: 'B',
      day: 'Thursday',
      style: 'strength',
    ...
    {
      id: 'week-b-friday-strength',
      name: 'Full Body - Explosive HIIT',
      description: 'High-intensity explosive movements with strength focus',
      week: 'B',
      day: 'Friday',
      style: 'strength',
      focus: ['fullBody', 'core'],
